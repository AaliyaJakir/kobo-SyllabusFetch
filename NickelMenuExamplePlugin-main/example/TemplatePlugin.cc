...
TemplatePlugin::TemplatePlugin() : m_listWidget(nullptr), m_process(nullptr)
{
    // Constructor
}
...
void TemplatePlugin::showNotebookSelection()
{
    clearLayout();
    ...
    connect(selectButton, &QPushButton::clicked, this, &TemplatePlugin::onNotebookSelected);
...
void TemplatePlugin::onNotebookSelected()
{
    ...
    connect(m_process, static_cast<void(QProcess::*)(int, QProcess::ExitStatus)>(&QProcess::finished),
            this, &TemplatePlugin::onSearchFinished);
...
void TemplatePlugin::onSearchFinished(int exitCode, QProcess::ExitStatus exitStatus)
{
...
void TemplatePlugin::showCourseSelection(const QString &response)
{
    // Parse JSON response
    ...
    selectButton->installEventFilter(this);
    connect(selectButton, &QPushButton::clicked, this, &TemplatePlugin::onCourseSelected);
    buttonLayout->addWidget(selectButton);
...
void TemplatePlugin::onCourseSelected()
{
...
void TemplatePlugin::fetchSyllabus(const QString &courseUrl)
{
    cleanupProcess();
    m_process = new QProcess(this);
    connect(m_process, static_cast<void(QProcess::*)(int, QProcess::ExitStatus)>(&QProcess::finished),
            this, &TemplatePlugin::onSyllabusFinished);
...
void TemplatePlugin::onSyllabusFinished(int exitCode, QProcess::ExitStatus exitStatus)
{
    QString response = m_process->readAllStandardOutput();
    QString error = m_process->readAllStandardError();
...
void TemplatePlugin::clearLayout()
{
...
void TemplatePlugin::cleanupProcess()
{
    if (m_process) {
...
void TemplatePlugin::showErrorMessage(const QString& message, bool isWarning)
{
